...
function page() {
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between px-4 md:px-0 gap-10">
          ...
          >
            <p className="text-gray-500 font-medium">
              India’s Most Trusted FASTag Recharge & Toll Management Service
            </p>

            <h1 className="text-4xl md:text-5xl font-bold leading-tight text-gray-900">
              Instant{" "}
              <span className="text-[#fa9404] swing">FASTag Recharge</span>{" "}
              <br />&{" "}
              <span className="text-[#fa9404] backInLeft">Hassle-Free</span>{" "}
              E-Challan Services
            </h1>

            <p className="text-gray-500 text-base md:text-lg leading-relaxed">
              Recharge any FASTag, check toll balance, track deductions, pay
              challans, and manage all your vehicle toll services from one
              simple platform.
            </p>
          ...
          >
            <div className="relative w-[540px] h-[400px] rounded-2xl mx-auto overflow-hidden group">
      ...
      <section className="py-10 px-4 md:px-0 max-w-6xl mx-auto">
        <div className="mt-5 grid grid-cols-1 md:grid-cols-2  items-center">
          ...
          <div className="space-y-5">
            ...
            <p className="mt-2 text-gray-600 max-w-2xl">
              We provide professional FASTag recharge and eChallan management
              services with a focus on convenience, security, and customer
              satisfaction. Our platform is trusted by thousands of users across
              India.
            </p>
